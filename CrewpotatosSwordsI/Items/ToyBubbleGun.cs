...
{
	public class ToyBubbleGun : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Fun with bubbles! But why does it use bullets?");
		}
		...
		public override void SetDefaults() {
			...
			item.value = 5; // how much the item sells for (measured in copper)
			item.rare = 0; // the color that the item's name will be in-game
			item.UseSound = SoundID.Item11; // The sound that this item plays when used.
			item.autoReuse = true; // if you can hold click to automatically use it again
            item.shoot = ModContent.ProjectileType<Projectiles.Bubble>(); ; //idk why but all the guns in the vanilla source have this
		...
		public override void AddRecipes() {
            ...
            recipe.AddIngredient(mod, "BubbleGel", 10);
