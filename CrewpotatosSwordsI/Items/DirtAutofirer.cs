...
{
	public class DirtAutofirer : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Not very ideal, at least its better than a dirt pistol. And it has autofire. It does fire slower than a Dirt Pistol.");
		}
		...
		public override void AddRecipes() {
            ...
            recipe.AddIngredient(mod, "DirtPistol");
